...
Definition ASMToString_funs := [
  ...
  inst2str_sub_prog;
  inst2str_div_prog;
  inst2str_jump_always_prog;
  inst2str_jump_equal_prog;
  inst2str_jump_less_prog;
  inst2str_call_prog;
  inst2str_ret_prog;
  inst2str_pop_prog;
  inst2str_push_prog;
  ...
  instrs2str_prog;
  concat_strings_prog;
  asm2str_header1_prog;
  asm2str_header2_prog;
  asm2str_header3_prog;
  asm2str_prog
].
...
Proof.
  ...
  assert_eval_app_by 'inst2str_jump_always 'inst2str_jump_always_prog_proof 'Hlookup_fun 8.
  assert_eval_app_by 'inst2str_jump_equal 'inst2str_jump_equal_prog_proof 'Hlookup_fun 9.
  assert_eval_app_by 'inst2str_jump_less 'inst2str_jump_less_prog_proof 'Hlookup_fun 10.
  assert_eval_app_by 'inst2str_call 'inst2str_call_prog_proof 'Hlookup_fun 11.
  assert_eval_app_by 'inst2str_ret 'inst2str_ret_prog_proof 'Hlookup_fun 12.
  assert_eval_app_by 'inst2str_pop 'inst2str_pop_prog_proof 'Hlookup_fun 13.
  assert_eval_app_by 'inst2str_push 'inst2str_push_prog_proof 'Hlookup_fun 14.
  assert_eval_app_by 'inst2str_load_rsp 'inst2str_load_rsp_prog_proof 'Hlookup_fun 15.
  assert_eval_app_by 'inst2str_store_rsp 'inst2str_store_rsp_prog_proof 'Hlookup_fun 16.
  assert_eval_app_by 'inst2str_add_rsp 'inst2str_add_rsp_prog_proof 'Hlookup_fun 17.
  assert_eval_app_by 'inst2str_sub_rsp 'inst2str_sub_rsp_prog_proof 'Hlookup_fun 18.
  assert_eval_app_by 'inst2str_store 'inst2str_store_prog_proof 'Hlookup_fun 19.
  assert_eval_app_by 'inst2str_load 'inst2str_load_prog_proof 'Hlookup_fun 20.
  assert_eval_app_by 'inst2str_getchar1 'inst2str_getchar1_prog_proof 'Hlookup_fun 21.
  assert_eval_app_by 'inst2str_putchar 'inst2str_putchar_prog_proof 'Hlookup_fun 22.
  assert_eval_app_by 'inst2str_exit 'inst2str_exit_prog_proof 'Hlookup_fun 23.
  assert_eval_app_by 'inst2str_comment 'inst2str_comment_prog_proof 'Hlookup_fun 24.
  assert_eval_app_by 'inst2str 'inst2str_prog_proof 'Hlookup_fun 25.
  assert_eval_app_by 'instrs2str 'instrs2str_prog_proof 'Hlookup_fun 26.
  assert_eval_app_by 'concat_strings 'concat_strings_prog_proof 'Hlookup_fun 27.
  assert_eval_app_by 'asm2str_header1 'asm2str_header1_prog_proof 'Hlookup_fun 28.
  assert_eval_app_by 'asm2str_header2 'asm2str_header2_prog_proof 'Hlookup_fun 29.
  assert_eval_app_by 'asm2str_header3 'asm2str_header3_prog_proof 'Hlookup_fun 30.
  assert_eval_app_by 'asm2str 'asm2str_prog_proof 'Hlookup_fun 31.
  eauto.
Qed.
