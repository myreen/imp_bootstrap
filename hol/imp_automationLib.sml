structure imp_automationLib :> imp_automationLib =
struct
...
open source_valuesTheory source_syntaxTheory source_semanticsTheory
     ...
     automation_lemmasTheory imp_automation_lemmasTheory
     imp_to_asmTheory;
...
(*  val _ = check_defun defun *)
  ...
  fun get_program main = let
    ...
    in list_mk_comb(“source_syntax$Program”,[ds,main]) end
...
val ty_invs = ref [(“:bool”,“bool”),
                   ...
                   (“:char”,“char”),
                   (“:token”,“token”),
                   (“:imp_source_syntax$exp”,“imp_automation_lemmas$exp”),
                   (“:imp_source_syntax$cmp”,“imp_automation_lemmas$cmp”),
                   (“:imp_source_syntax$test”,“imp_automation_lemmas$test”),
                   (“:imp_source_syntax$cmd”,“imp_automation_lemmas$cmd”),
                   (“:imp_source_syntax$func”,“imp_automation_lemmas$func”),
                   (“:imp_source_syntax$prog”,“imp_automation_lemmas$prog”),
                   (“:word64”,“automation_lemmas$word:word64->source_values$v”),
                   (“:word4”,“automation_lemmas$word:word4->source_values$v”),
                   (“:reg”,“reg”),
                   (“:cond”,“cond”),
                   (“:inst”,“inst”),
                   (“:v”,“deep”)];
...
val trans_thms    = ref (DB.find "auto_"
  |> filter (fn ((thy,_),_) => String.isSuffix "automation_lemmas" thy)
...
in
  val parse_exp = parse_any ``parsing$v2exp``
  val parse_dec = parse_any ``parsing$v2dec``
end
