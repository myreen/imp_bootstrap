  ...
  Program [
    Func (name_enc "main") [] (
      Seq (
        ...
        Seq
          (Assign (name_enc "x") (Const (word.of_Z 42)))
          (Seq
            (If (Test Equal (Var (name_enc "x")) (Const (word.of_Z 42)))
                (PutChar (Const (word.of_Z 66)))
                (PutChar (Const (word.of_Z 67)))
            )
...
Eval lazy in imp2str (str2imp (list_ascii_of_string (imp2str some_program1))).
